        ...
        <header className="bg-white shadow">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <h1 className="text-2xl font-bold text-gray-900">OJT Hours Counter</h1>
          ...
          <div className="px-4 py-6 sm:px-0">
            <div className="bg-white overflow-hidden shadow rounded-lg mb-6">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Add Entry</h3>
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 block w-full rounded-md border border-gray-400 bg-white px-3 py-2 text-gray-950 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-800">Time In</label>
                      <input
                        type="time"
                        value={form.timeIn}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-800">Time Out</label>
                      <input
                        type="time"
                        value={form.timeOut}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-800">Break Time (hours)</label>
                      <input
                        type="number"
                        min="0"
                        step="0.25"
                  ...
                  <div className="flex space-x-2">
                    ...
                    {editingId && (
                      <button
                        ...
                        className="inline-flex justify-center py-2 px-4 border border-gray-400 shadow-sm text-sm font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                      >
                        Cancel
                      </button>
                    )}
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg mb-6">
              <div className="px-4 py-5 sm:p-6">
                ...
                <p className="text-sm text-gray-600">Target: {targetHours} hours ({progress.toFixed(1)}% complete)</p>
              </div>
            </div>

            <div className="bg-white shadow overflow-hidden sm:rounded-md">
              <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Entries</h3>
                <div className="space-x-2">
                  <button
                    onClick={exportCSV}
                    className="inline-flex items-center px-3 py-2 border border-gray-400 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
                    Export CSV
                  </button>
                  <button
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Break (hrs)</th>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {entries.map((entry) => (
                      <tr key={entry.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{entry.breakTime}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{entry.hours.toFixed(2)}</td>
